...
$titulo_doc_ata = "Ata $num_doc_ata - Assembleia $titulo_doc_ata";

$hoje = date('d/m/Y H:i:s');
date_default_timezone_set('America/Fortaleza');

$dir = "assinaturas_doc_ata_ass"; 
...
(`num_doc_ata`,	`titulo_doc_ata`,	`data_reuniao_doc_ata`,	`horario_doc_ata`,	`local_doc_ata`,	`pautas_doc_ata`,	`enc_doc_ata`,	`presentes_doc_ata`,	`corpo_doc_ata`,
