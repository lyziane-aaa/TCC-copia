...
function Header()
{
    ...
    $this->Image('../_documentos/elementos/img/logo_ifmo.png',160,10,30); //156 � o tamanho da p�gina sem as margens
...
{   
    ...
    $this->SetFontSize('11');
    // Page number
    $this->Cell(156,5,'Rua Raimundo Firmino de Oliveira, nº 400, Sala 74, Conj. Ulrick Graff, Mossor�-RN � CEP 59628-330',0,0,"L"); // Alinhamento "L" apenas para n�o ficar torto
    $this->Ln(4);
