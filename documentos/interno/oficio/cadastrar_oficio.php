...
-->
					...
					<div id="numeracaoOficio">
						...
						<input id ="input-numeracaoOficio" type="text" placeholder="OFÍCIO <ANO>.<NÚMERO>/<SIGLA DA DIRETORIA>/GEVP" name="num_doc_ofc" required>
					</div>

					
					<div id="dataOficio">
					<input id ="input-dataOficio" type="text" placeholder="<Local>, <dia> de <mês> de <ano>." name="data_doc_ofc" required>
					</div>
