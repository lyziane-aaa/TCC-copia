<?php
	...
	$resultado_insert = "INSERT INTO documentos_ofc (titulo_doc_ofc,num_doc_ofc,data_doc_ofc,endrc_doc_ofc,assunto_doc_ofc,corpo_doc_ofc,fecho_doc_ofc,assinatura_doc_ofc,matricula_doc_ofc, cargo_doc_ofc,data_registro_ofc,gremista_registro_ofc) 
	VALUES ('$titulo_doc_ofc','$num_doc_ofc','$data_doc_ofc','$endrc_doc_ofc','$assunto_doc_ofc','$corpo_doc_ofc','$fecho_doc_ofc','$assinatura_doc_ofc','$matricula_doc_ofc', '$cargo_doc_ofc',NOW(),'$gremista_registro_ofc')";
	// 
