...
$result_doc="SELECT id_doc_ofc,titulo_doc_ofc, data_registro_ofc, assinatura_doc_ofc FROM documentos_ofc";
$resultado_doc=mysqli_query($conn,$result_doc);
$linhas=mysqli_num_rows($resultado_doc);
//pegar dados

//Obter dados
$result_doc_ofc="SELECT id_doc_ofc, titulo_doc_ofc,data_registro_ofc,assinatura_doc_ofc FROM documentos_ofc WHERE 1=1";
